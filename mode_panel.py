...
def manipulate(init_target_layout, sliders, eval_and_layout):
    ...
    def update_if_requested(event=None):
        ...
        if update_requested:
            ...
            with util.Timer("slider update"):
                ...
                # TODO: this is the alternative if we can't use Plotly
    ...
    # TODO: Plotly only works if layout is a Figure
    # alternative is a Column whose contents we change
    # but Plotly is a lot more efficient for Figures
